Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/Lihuo/MPageMenus"
  ...
  spec.source       = { :git => "https://github.com/Lihuo/MPageMenus.git", :tag => "#{spec.version}" }

  #spec.source_files  = "Classes", "Classes/**/*.{h,m}"
  spec.source_files  = "MPageMenus/**/*.{h,m,swift}"
